...
module.exports.createWebDriver = function(options) {
  ...
  switch (browser) {
    ...
    case 'firefox':
      ...
      profile.setPreference('devtools.toolbox.selectedTool', 'network');

      profile.addExtension(path.join(__dirname, '../../vendor/har_export_trigger-0.5.0-beta.6-fx.xpi'));
      profile.setPreference('extensions.netmonitor.har.contentAPIToken', 'browsertime');
